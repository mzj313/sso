...
@Component
public class ClientIdSecurityCheck extends SecurityCheck {

    private static Logger logger= LoggerFactory.getLogger(ClientIdSecurityCheck.class);
    private static final String IP_PREFIX = "server_client_id_prefix_";
    private static final String INTERCEPT_PREFIX = "server_client_id_intercept_prefix_";
