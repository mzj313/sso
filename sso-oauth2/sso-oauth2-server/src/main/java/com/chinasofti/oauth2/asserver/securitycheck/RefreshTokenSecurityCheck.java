...
@Component
public class RefreshTokenSecurityCheck extends SecurityCheck {

    private static Logger logger= LoggerFactory.getLogger(RefreshTokenSecurityCheck.class);
    private static final String IP_PREFIX = "server_refresh_token_prefix_";
    private static final String INTERCEPT_PREFIX = "server_refresh_token_intercept_prefix_";
    ...
    public void setOperateJedisImpl(OperateJedisImpl operateJedisImpl) {
