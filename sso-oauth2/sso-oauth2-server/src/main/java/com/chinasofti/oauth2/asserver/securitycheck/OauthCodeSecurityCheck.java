...
@Component
public class OauthCodeSecurityCheck extends SecurityCheck {

    private static Logger logger= LoggerFactory.getLogger(OauthCodeSecurityCheck.class);
    private static final String IP_PREFIX = "server_oauth_code_prefix_";
    private static final String INTERCEPT_PREFIX = "server_oauth_code_intercept_prefix_";
