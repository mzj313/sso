...
@Component
public class GetTokenSecurityCheck extends SecurityCheck {

    private static Logger logger= LoggerFactory.getLogger(GetTokenSecurityCheck.class);
    private static final String IP_PREFIX = "server_get_token_prefix_";
    private static final String INTERCEPT_PREFIX = "server_get_token_intercept_prefix_";
    @Autowired
