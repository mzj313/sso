...
<div class="content">
    <div class="center">
        <form id="loginForm" action="" method="post" onsubmit="return validityForm();">
            <div class="loginarea">
                <div class="headImg">
                    <img src="${pageContext.request.contextPath}/static/extends/default/imgs/logo.png">
                </div>
                <div class="inputarea">
                    <div class="input">
                        <div class="icon"><img src="${pageContext.request.contextPath}/static/extends/default/imgs/icon01.png"></div>
                    ...
                    <div class="input">
                        <div class="icon"><img src="${pageContext.request.contextPath}/static/extends/default/imgs/icon02.png"></div>
                    ...
                    <div class="input">
                        <div class="icon"><img src="${pageContext.request.contextPath}/static/extends/default/imgs/icon03.png"></div>
