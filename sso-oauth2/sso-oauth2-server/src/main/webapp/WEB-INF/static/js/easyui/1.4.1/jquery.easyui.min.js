...
var _98=_97.options;
$(_95).removeClass("l-btn-disabled l-btn-plain-disabled l-btn-custom-disabled");
if(_96){
_98.disabled=true;
...
_98.plain?$(_95).addClass("l-btn-disabled l-btn-plain-disabled"):$(_95).addClass("l-btn-disabled l-btn-custom-disabled");
}else{
_98.disabled=false;
if(_97.href){
...
$.fn.linkbutton.defaults={id:null,disabled:false,toggle:false,selected:false,group:null,plain:false,text:"",cls:'',iconCls:null,iconAlign:"left",size:"small",onClick:function(){
}};
})(jQuery);
(function($){
function _a0(_a1){
