...
//                .append(Constant.HTTP_REQUEST_PARAM_OPEN_ID).append("=").append(request.getOpenid()).append("&")
//                .append(Constant.HTTP_REQUEST_PARAM_CLIENT_ID).append("=").append(request.getClientid()).append("&");
...
//        }
//        try {
//            url.append(Constant.HTTP_REQUEST_PARAM_SIGN).append("=").append(createSign(request, appsecret));
//        } catch (Exception e) {
//            e.printStackTrace();
